...
import img from "public/howitworksimg.png";

export default function HowItWorks() {
  return (
    <div
      id="howItWroks"
      className="space-y-[60px] text-center bg-[#fff] p-[100px] "
    >
      <h1 className="text-[40px] font-bold font-sora">How it works</h1>

      <div className="font-inter flex gap-x-[83px]">
        <div className="text-center flex flex-col justify-center items-center">
          <p className="text-[#fff] bg-primary-500 font-bold w-fit py-[14px] px-[22px] rounded-full mb-8">
            1
          </p>
          <p className="text-[28px] font-semibold mb-4">Record Screen</p>
          <p className=" text-[#616163] text-xl font-normal font-workSans leading-[30.26px] mb-7">
            Click the &ldquo;Start Recording&ldquo; button in our extension.
          ...
          <Image
            src={img}
            alt="image"
            className="w-[358px] h-[270px] object-contain"
          />
        </div>
